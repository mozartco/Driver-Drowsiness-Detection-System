...
st.subheader('Developed for BANA 274 - Deep Learning & Applications Coursework', divider='rainbow')
st.subheader('Authored by :blue[Anurag Ramesh Patil, Bijay Gautham, Justin Gamoras, Sara Hart, Shri Hari Sekar, Suyog Sanklapur] :sunglasses:', divider='green')
